...
You can bring your log data into New Relic using a [compatible log forwarding plugin](/docs/enable-new-relic-logs#compatibility-requirements), or with [OpenTelemetry](/docs/integrations/open-source-telemetry-integrations/opentelemetry/data-types/opentelemetry-logs).
